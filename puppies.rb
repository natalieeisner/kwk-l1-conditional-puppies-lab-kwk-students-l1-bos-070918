...
def less_puppies(number_of_puppies)
  if number_of_puppies < 3 
    ...
    "Get back to your animal restrictions Rachel!"
  end 
end
...
def some_puppies(number_of_puppies,maxium_puppy_allowance)
if number_puppies < maxium2
  "Good job, Rachel!"
else
  "Get back to your animal goals!"
endend
puts some_puppies(15,33)
...
def new-animal(puppies, cats)
if puppies == 0 || cats == 10
"Good job!"
elsif puppies > 0 && cats > 10
"Get back to your animal goals!"
end
end
